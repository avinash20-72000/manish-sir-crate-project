                    ...
                    <div class="justify-content-end d-flex">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-custom">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Permission Form</span></li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    {{Form::select("module_id",$modules, null, ['class'=>'form-control','placeholder'=>'Select Module','data-placeholder'=>'Select Module','required'])}}
                </div>
                <div class="form-group">
